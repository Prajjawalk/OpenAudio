...
//         } catch (error: any) {
//           await callback(`Failed to retrieve audio file: ${error.message || String(error)}`);
//           return false;
//         }
...
//       await callback(`Your remixed audio in ${genre} style is ready: ${result.remixedFileUrl}`);

//       return true;
//     } catch (error: any) {
//       await callback(`Failed to remix audio: ${error.message || String(error)}`);
//       return false;
//     }
//   }
// };
